...
class WeekCalendarAdapter(
   private val context: Context
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WeekCalendarViewHolder {
        ...
        val holder = WeekCalendarViewHolder(view, context);
        return holder
    }
    ...
    class WeekCalendarViewHolder(itemView : View, private val context: Context): RecyclerView.ViewHolder(itemView){
        ...
        public val dayFormat = DecimalFormat("00")
